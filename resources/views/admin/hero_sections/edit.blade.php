    ...
    @method('PUT')
                    <div>
                        ...
                        <x-text-input id="heading" class="block mt-1 w-full" type="text" name="heading" 
                          required autofocus autocomplete="heading" :value="old('heading', $hero_section->heading)"/>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="subheading" class="block mt-1 w-full" type="text" name="subheading"  required autofocus autocomplete="subheading" :value="old('subheading', $hero_section->subheading)" />
                        <x-input-error :messages="$errors->get('subheading')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="achievement" :value="__('achievement')" />
                        <x-text-input id="achievement" class="block mt-1 w-full" type="text" name="achievement"  required autofocus autocomplete="achievement" :value="old('achievement', $hero_section->achievement)" />
                        <x-input-error :messages="$errors->get('achievement')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="path_video" :value="__('path_video')" />
                        <x-text-input id="path_video" class="block mt-1 w-full" type="text" name="path_video" required autofocus autocomplete="path_video" :value="old('path_video', $hero_section->path_video)" />
