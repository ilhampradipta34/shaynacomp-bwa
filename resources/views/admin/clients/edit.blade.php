    ...
    @method('PUT')
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" 
                         required autofocus autocomplete="name":value="old('name', $client->name)" />
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="occupation" :value="__('occupation')" />
                        <x-text-input id="occupation" class="block mt-1 w-full" type="text" name="occupation"   required autofocus autocomplete="occupation" :value="old('occupation', $client->occupation)"/>
