...
@section('content')
  <div id="header" class="bg-[#F6F7FA] relative overflow-hidden">
    <div class="container max-w-[1130px] mx-auto relative pt-10 z-10">
        @forelse ($hero_sections as $heroSection)  
        <div id="Hero" class="flex flex-col gap-[30px] mt-20 pb-20">
          ...
          <div class="flex items-center gap-4">
            <a href="{{ $heroSection->path_video }}" class="bg-cp-dark-blue p-5 w-fit rounded-xl hover:shadow-[0_12px_30px_0_#312ECB66] transition-all duration-300 font-bold text-white">Explore Now</a>
